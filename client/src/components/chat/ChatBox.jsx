...
import Stack from 'react-bootstrap/Stack'; // Assuming you're using Bootstrap's Stack component
...
const ChatBox = () => {
    ...
    // Add these logs to inspect the values
            ...
            <Stack gap={4} className="chat-box">
                ...
                <Stack direction="horizontal" gap={3} className="chat-input flex-grow-0">
                    ...
                    <button className="send-btn" onClick={() => sendTextMessage(textMessage, user, currentChat._id, setTextMessage)}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="" className="bi bi-send-fill" viewBox="0 0 16 16">
    ...
    // if (!recipientUser) {
    //     return (
    //         <p style={{ textAlign: "center", width: "100%" }}>Please select a conversation</p>
    //     );
    // }
